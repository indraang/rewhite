...
<!-- //for-mobile-apps -->
<link href="<?= base_url();?>assets/template/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<!-- pignose css -->
<link href="<?= base_url();?>assets/template/css/pignose.layerslider.css" rel="stylesheet" type="text/css" media="all" />


<!-- //pignose css -->
<link href="<?= base_url();?>assets/template/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- js -->
<script type="text/javascript" src="<?= base_url();?>assets/template/js/jquery-2.1.4.min.js"></script>
<!-- //js -->
<!-- cart -->
	<script src="<?= base_url();?>assets/template/js/simpleCart.min.js"></script>
<!-- cart -->
<!-- for bootstrap working -->
	<script type="text/javascript" src="<?= base_url();?>assets/template/js/bootstrap-3.1.1.min.js"></script>
<!-- //for bootstrap working -->
